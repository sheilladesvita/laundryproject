    ...
    <body class="bg-default-blue">
        <div class="container d-flex justify-content-center align-items-center vh-100">
         <div class="bg-white text-center p-5 mt-3 width-form-50 center">
            ...
            <form autocomplete="off" action="<?php echo base_url();?>viewonly/reset_newPassword" method="post">
                <div class="form-group">
                    <input type="password" id="newPassword" name="newPassword" class="form-control" placeholder="New Password*" minlength="8" required>
                </div>
                <div class="form-group">
